            ...
            public void onClick(View v) {
                ...
                if (getStatus()) {
                  ...
                  //  SharedPreferences sharedPreferences = getSharedPreferences(SHARE_PRE_NAME, MODE_PRIVATE);
                    //sqlHelper.InsertToComment(new YoutubeCommentModel(sharedPreferences.getString(ACCOUNT_ID, ""), cmt, "http://xemanhdep.com/wp-content/uploads/2016/05/avatar-dep-de-thuong.jpg", id, sharedPreferences.getInt(ACCOUNT_ID, 0)));
        ...
        if (jsonObject.has("items")) {
            try {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    SharedPreferences sharedPreferences = getSharedPreferences(SHARE_PRE_NAME, MODE_PRIVATE);
                    //String title, String comment, String publishedAt, String thumbnail, String video_id, int idacc, int id
                   // sqlHelper.InsertToComment(new YoutubeCommentModel(title, comment, thumbnail, id, sharedPreferences.getInt(ACCOUNT_ID, 0)));
