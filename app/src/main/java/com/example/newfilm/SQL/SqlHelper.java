...
public class SqlHelper extends
    ...
    static final String DB_NAME = "FILMNEW.db";
    ...
    static final String DB_TABLE_COMMENT = "Comment";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String queryCreateTableComment = "CREATE TABLE "+ DB_TABLE_COMMENT +"(" +
                "id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT," +
                "idAcc INTEGER,"+
                "title Text," +
                "publishedAt Text," +
                ...
                "videoID Text,"+
                "comment Text)";
        db.execSQL(queryCreateTableComment);
    }
...
//         "comment Text)";
    ...
    public void InsertToComment(YoutubeCommentModel cmt) {
        sqLiteDatabase = getWritableDatabase();
        contentValues = new ContentValues();
        contentValues.put("idAcc",cmt.getId());
        contentValues.put("title", cmt.getTitle());
        contentValues.put("publishedAt", cmt.getPublishedAt());
        contentValues.put("thumbnail", cmt.getThumbnail());
        contentValues.put("videoID", cmt.getVideo_id());
        contentValues.put("comment", cmt.getComment());
        sqLiteDatabase.insert(DB_TABLE_COMMENT, null, contentValues);
    }
//    public List<YoutubeCommentModel> getComMent(){
//        List<YoutubeCommentModel> list = new ArrayList<>();
//        sqLiteDatabase = getReadableDatabase();
//        Cursor cursor = sqLiteDatabase.query(false,DB_TABLE_COMMENT,
//                null,
//                null,
//                null,
//                null,
...
//            //String publishedAt, String title, String description, String url, String kind, String videoID, String playlistId, int id) {
//            list.add(new YoutubeCommentModel( title,  comment,  publishedAt,  thumbnail,  videoID,  idAcc,  id));
//        }
//        return list;
//    }
