...
public class YoutubeCommentModel implements Parcelable {
    ...
    public YoutubeCommentModel(String title, String comment, String publishedAt, String thumbnail, String video_id, int idacc, int id) {
        this.title = title;
    ...
    public YoutubeCommentModel(String title, String comment,String thumbnail, String video_id, int idacc) {
        this.title = title;
        this.comment = comment;
        this.thumbnail = thumbnail;
        this.video_id = video_id;
